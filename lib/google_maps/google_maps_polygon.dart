...
class GoogleMapsPlacePolygonPage extends Page {
  GoogleMapsPlacePolygonPage() : super(const Icon(Icons.linear_scale), 'Place polygon');

  static Route<dynamic> route() {
    return MaterialPageRoute(
      builder: (_) => GoogleMapsPlacePolygonPage(),
    );
  }
