...
class GoogleMapsPlaceCirclePage extends Page {
  GoogleMapsPlaceCirclePage() : super(const Icon(Icons.linear_scale), 'Place circle');

  static Route<dynamic> route() {
    return MaterialPageRoute(
      builder: (_) => GoogleMapsPlaceCirclePage(),
    );
  }
