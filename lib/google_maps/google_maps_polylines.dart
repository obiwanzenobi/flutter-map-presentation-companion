...
class GoogleMapsPlacePolylinePage extends Page {
  GoogleMapsPlacePolylinePage() : super(const Icon(Icons.linear_scale), 'Place polyline');

  static Route<dynamic> route() {
    return MaterialPageRoute(
      builder: (_) => GoogleMapsPlacePolylinePage(),
    );
  }
                        ...
                        Column(
                          children: <Widget>[
                            ...
                            FlatButton(
                              ...
                              onPressed: (selectedPolyline == null) ? null : _toggleGeodesic,
                            ),
                          ],
                        ),
                        Flexible(
